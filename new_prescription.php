...
if(isset($_POST['submit'])) {
  ...
  try {
    ...
    `next_visit_date`, `description`, `patient_id`) 
    VALUES('$visitDate', 
...
include './config/sidebar.php';?>  
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="componentTitle">Add History</h1>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      </section>
      ...
      <section class="content">
        ...
        <div class="card card-outline bg-line rounded-0 shadow">
          ...
          <h3 class="card-title">Add Patient's Visit Information</h3>
      ...
      <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
        ...
        <input id="description" required="required" name="description" class="form-control form-control-sm rounded-0" />
      </div>
    ...
    <div class="col-lg-1 col-md-1 col-sm-6 col-xs-12">
      <label>&nbsp;</label>
      <button id="add_to_list" type="button" class="btn bg-btn btn-sm btn-flat btn-block">
  ...
  <div class="row">
    ...
    <div class="col-md-2">
      ...
      class="btn btn-sm btn-flat btn-block bg-btn">Save</button>
    </div>
  </div>
</form>
